...
from discernment_dev_tools import CodeReflector, DevToolMetadata


def main(target: str = "."):
    """Run CodeReflector on target directory"""

    # Create tool instance
    metadata = DevToolMetadata(
        tool_id="ed1ff969a44b",
        name="CodeReflector_L4",
        tool_type="CodeReflector",
        layer="GREEN",
        color_hex="#00FF88",
    ...
    tool = CodeReflector(metadata)

    # Execute
    print(f"Running CodeReflector_L4 on {target}...")
