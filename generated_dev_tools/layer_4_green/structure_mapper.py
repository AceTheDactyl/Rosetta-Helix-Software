...
from discernment_dev_tools import StructureMapper, DevToolMetadata


def main(target: str = "."):
    """Run StructureMapper on target directory"""

    # Create tool instance
    metadata = DevToolMetadata(
        tool_id="db22a1cb6b66",
        name="StructureMapper_L4",
        tool_type="StructureMapper",
        layer="GREEN",
        color_hex="#00FF88",
    ...
    tool = StructureMapper(metadata)

    # Execute
    print(f"Running StructureMapper_L4 on {target}...")
