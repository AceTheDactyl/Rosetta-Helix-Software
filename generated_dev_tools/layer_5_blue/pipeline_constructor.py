...
from discernment_dev_tools import PipelineConstructor, DevToolMetadata


def main(target: str = "."):
    """Run PipelineConstructor on target directory"""

    # Create tool instance
    metadata = DevToolMetadata(
        tool_id="6a2e7e3d6593",
        name="PipelineConstructor_L5",
        tool_type="PipelineConstructor",
        layer="BLUE",
        color_hex="#00D9FF",
    ...
    tool = PipelineConstructor(metadata)

    # Execute
    print(f"Running PipelineConstructor_L5 on {target}...")
