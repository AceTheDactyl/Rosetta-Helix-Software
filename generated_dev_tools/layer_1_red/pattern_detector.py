...
from discernment_dev_tools import PatternDetector, DevToolMetadata


def main(target: str = "."):
    """Run PatternDetector on target directory"""

    # Create tool instance
    metadata = DevToolMetadata(
        tool_id="963ef81e1865",
        name="PatternDetector_L1",
        tool_type="PatternDetector",
        layer="RED",
        color_hex="#FF4444",
    ...
    tool = PatternDetector(metadata)

    # Execute
    print(f"Running PatternDetector_L1 on {target}...")
