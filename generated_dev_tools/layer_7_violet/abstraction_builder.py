...
from discernment_dev_tools import AbstractionBuilder, DevToolMetadata


def main(target: str = "."):
    """Run AbstractionBuilder on target directory"""

    # Create tool instance
    metadata = DevToolMetadata(
        tool_id="597ad4ea884b",
        name="AbstractionBuilder_L7",
        tool_type="AbstractionBuilder",
        layer="VIOLET",
        color_hex="#AA44FF",
    ...
    tool = AbstractionBuilder(metadata)

    # Execute
    print(f"Running AbstractionBuilder_L7 on {target}...")
