...
from discernment_dev_tools import IntegrationWeaver, DevToolMetadata


def main(target: str = "."):
    """Run IntegrationWeaver on target directory"""

    # Create tool instance
    metadata = DevToolMetadata(
        tool_id="b81113d55cb4",
        name="IntegrationWeaver_L7",
        tool_type="IntegrationWeaver",
        layer="VIOLET",
        color_hex="#AA44FF",
    ...
    tool = IntegrationWeaver(metadata)

    # Execute
    print(f"Running IntegrationWeaver_L7 on {target}...")
